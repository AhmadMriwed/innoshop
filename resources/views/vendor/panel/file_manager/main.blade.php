    ...
    <div id="app">
                    ...
                    <el-col :span="12">
                        <el-button-group>
                            <el-button type="primary" size="small" @click="uploadFile">
                                <i class="el-icon-upload2"></i> Upload files
                            </el-button>
                            <el-button size="small" @click="createFolder">
                                <i class="el-icon-folder-add"></i>  Create a new folder
                            </el-button>
                        </el-button-group>
                    </el-col>
                ...
                <el-col :span="18">
                    <div class="file-list">
                                ...
                                <el-col :span="12">
                                    <el-button-group>
                                        <el-button
                                            ...
                                            <i class="el-icon-check"></i> Multiple selection mode
                                        </el-button>
                                        <el-button
                        ...
                        <div v-loading="loading" element-loading-text="Loading...">
                                ...
                                <el-col :span="6" v-for="file in files" :key="file.id || file.path">
                                    <div :class="['file-card', {selected: selectedFiles.includes(file.id || file.path)}]"
                                        ...
                                        <div class="file-info">
                                            ...
                                            <p class="file-type">@{{ file.is_dir ? 'Folders' : file.mime }}</p>
                                        </div>
                                    </div>
                                </el-col>
                            </el-row>
                            ...
                            <!-- 添加空状态 -->
                            <el-empty v-else description="No files yet" :image-size="120"></el-empty>
                        </div>
                    </div>
                </el-col>
            </el-row>
        ...
        <el-dialog
            ...
            <el-form :model="folderDialog.form" label-width="80px">
                <el-form-item label="Folder Name">
                    <el-input v-model="folderDialog.form.name" placeholder="Please enter a folder name"></el-input>
                </el-form-item>
            </el-form>
            <span slot="footer">
        <el-button @click="folderDialog.visible = false">Cancel</el-button>
        <el-button type="primary" @click="submitCreateFolder">Submit</el-button>
      </span>
        </el-dialog>
        ...
        <el-dialog
            ...
            <el-upload
                ...
                <div class="el-upload__text">Drag your files here, or<em>Click Upload</em></div>
                <div class="el-upload__tip" slot="tip">Supports image files in jpg, jpeg, png, and gif formats</div>
            </el-upload>
        </el-dialog>
    ...
    <script>
        new Vue({
            ...
            methods: {
                ...
                submitCreateFolder() {
                    if (!this.folderDialog.form.name) {
                        this.$message.warning('Please enter a folder name');
                        return;
                    }
                ...
                deleteFiles() {
                    ...
                    this.$confirm('Confirm deletion of selected files?', 'hint', {
                ...
                beforeUpload(file) {
                    ...
                    if (!isImage) {
                        this.$message.error('Only image files can be uploaded!');
                        return false;
                    }
                    ...
                    if (!isLt2M) {
                        this.$message.error('Image size cannot exceed 8MB！');
                        return false;
                    }
          ...
          <div class="cropper-controls">
            <button class="el-button el-button--default el-button--small cancel-btn">Cancle</button>
...
handleUploadSuccess(response, file, fileList) {
    ...
    // If all files have completed uploading, close the dialog
...
deleteFile() {
    const file = this.contextMenu.file;
    this.$confirm('Are you sure you want to delete this file?', 'Tip', {
    ...
    this.hideContextMenu();
                ...
                submitMove() {
                    if (!this.moveDialog.targetPath) {
                        this.$message.warning('Please select a destination folder');
                        return;
                    }
                    ...
                    http.post('file_manager/move_files', {
                        ...
                        if (res.success) {
                            this.$message.success('Mobile success');
...
deleteFolder() {
    const folder = this.folderContextMenu.folder;
    this.$confirm('Are you sure you want to delete this folder?', 'Tip', {
        confirmButtonText: 'Yes',
        cancelButtonText: 'No',
        type: 'warning'
    }).then(() => {
...
handleFolderMoveTargetSelect(data) {
    // Cannot move to itself or a subfolder of itself
    if (data.path === this.folderMoveDialog.folder.path ||
        data.path.startsWith(this.folderMoveDialog.folder.path + '/')) {
        this.$message.warning('Cannot move to itself or its subfolder');
        return;
    }
...
submitFolderMove() {
    if (!this.folderMoveDialog.targetPath) {
        this.$message.warning('Please select a target folder');
        return;
    }
