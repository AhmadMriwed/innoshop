    ...
    <div class="row">
      ...
      <div class="col-12 col-md-6">
        <div class="about-text">
          <div class="main-title">فريق يحركه الابتكار ، والتقنية الممتازة ، وخلق المستقبل معًا.</div>
          <div class="about-text-item">
            <div class="left"><i class="bi bi-check-circle"></i></div>
            <div class="right">
              <div class="title">我们的团队</div>
              <div class="sub-title">
              يتألف فريقنا من مجموعة من المهنيين العاطفيين والمبدعين الذين يأتون من خلفيات متنوعة ولكنهم يشتركون في شغف بالتكنولوجيا والسعي لتحقيق التميز. نحن نشجع التعاون والتواصل بين أعضاء الفريق على تعزيز تصادم التفكير المبتكر وتبادل المعرفة.
              </div>
            </div>
          </div>
          <div class="about-text-item">
